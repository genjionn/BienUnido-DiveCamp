...
<head>
    ...
    <style>
		*{margin:0;padding:0;list-style:none;text-decoration:none;box-sizing:border-box;font-family:Poppins,sans-serif}body{background:#fff}.wrapper .header{z-index:1;background:#e1a84b;position:fixed;width:calc(100% - 0%);height:70px;display:flex;top:0}.wrapper .header .header-menu{width:calc(100% - 0%);height:100%;display:flex;justify-content:space-between;align-items:center;padding:0 20px}.wrapper .header .header-menu .title{color:#fff;font-size:25px;text-transform:uppercase;font-weight:800}.wrapper .header .header-menu .title span{color:#004f5d}.wrapper .header .header-menu .sidebar-btn{color:#fff;position:absolute;margin-left:210px;font-weight:800;cursor:pointer;transition:.3s;transition-property:color}.wrapper .header .header-menu .sidebar-btn #hide-sidebar{display:none}.wrapper .header .header-menu .sidebar-btn:hover{color:#004f5d}.wrapper .header .header-menu ul{display:flex}.wrapper .header .header-menu ul li a{background:#fff;color:#000;display:block;margin:0 10px;font-size:18px;width:34px;height:34px;line-height:35px;text-align:center;border-radius:50%;transition:.3s;transition-property:background,color}.wrapper .header .header-menu ul li a:hover{background:#004f5d;color:#fff}.wrapper .sidebar{z-index:1;background:#e1a84b;position:fixed;top:70px;width:250px;height:calc(100% - 9%);transition:.3s;transition-property:width;overflow-y:auto}.wrapper .sidebar .sidebar-menu{overflow:hidden}.wrapper .sidebar .sidebar-menu .profile img{margin:20px 0;width:100px;height:100px;border-radius:50%}.wrapper .sidebar .sidebar-menu .profile p{color:#000;font-weight:600;margin-bottom:10px}.wrapper .sidebar .sidebar-menu .item{width:250px;overflow:hidden}.wrapper .sidebar .sidebar-menu .item .menu-btn{display:block;color:#000;position:relative;padding:10px 20px;transition:.3s;transition-property:color}.wrapper .sidebar .sidebar-menu .item .menu-btn:hover{color:#fff;background:#004f5d}.wrapper .sidebar .sidebar-menu .item .menu-btn i{margin:20px}.wrapper .main-container{width:(100% - 250px);margin-top:70px;margin-left:250px;padding:15px;background-size:cover;height:100vh;transition:.3s}.main-container{background:#fff}.main-container .profile-grid{display:flex;height:auto;width:100%;padding:20px 20px;background:#fff;border-radius:15px;box-shadow:-2px 0 21px 1px rgba(0,0,0,.56);-webkit-box-shadow:-2px 0 21px 1px rgba(0,0,0,.56);-moz-box-shadow:-2px 0 21px 1px rgba(0,0,0,.56)}.main-container .profile-grid img{display:block;width:100px;height:100px;border-radius:100px}.main-container .profile-grid .u-info{padding:15px 20px;display:inline-block}.main-container .profile-grid .u-info label{border:1px solid #004f5d;border-radius:100px;width:150px;text-align:center;padding:0 5px}.main-container .profile-grid .u-info i{font-size:12px}.main-container .profile-grid input{display:none}.main-container .profile-info{display:block;height:auto;width:100%;padding:20px 20px;background:#fff;border-top-right-radius:15px;border-top-left-radius:15px;box-shadow:-2px 0 21px 1px rgba(0,0,0,.56);-webkit-box-shadow:-2px 0 21px 1px rgba(0,0,0,.56);-moz-box-shadow:-2px 0 21px 1px rgba(0,0,0,.56)}input[type=text],select,textarea{width:100%;padding:12px;border:1px solid #004f5d;border-radius:15px;resize:vertical}input[type=email],select,textarea{width:100%;padding:12px;border:1px solid #004f5d;border-radius:15px;resize:vertical}input[type=password],select,textarea{width:100%;padding:12px;border:1px solid #004f5d;border-radius:15px;resize:vertical}label{padding:12px 12px 12px 0;display:inline-block}input[type=submit]{width:100px;margin:5px;background-color:#00f;color:#fff;padding:15px 20px;border:1px solid #00008b;border-radius:15px;cursor:pointer;float:right}input[type=button]{width:100px;margin:5px;background-color:red;color:#fff;padding:15px 20px;border:1px solid #8b0000;border-radius:15px;cursor:pointer;float:right}input[type=button]:hover{background-color:#8b0000}input[type=submit]:hover{background-color:#00008b}.profile-info form{border-top-right-radius:15px;border-top-left-radius:15px;background-color:#f2f2f2;padding:20px}.col-25{font-size:14px;float:left;width:15%;margin-top:6px;margin-left:50px}.col-75{float:left;width:70%;margin-top:10px}.row:after{content:"";display:table;clear:both}@media screen and (max-width:600px){.col-25,.col-75,input[type=button],input[type=submit],input[type=text]{font-size:12px;width:100px;height:50px;margin-top:0}body h3{font-size:14px}.main-container .profile-grid{width:100%;margin-top:0}.main-container .profile-grid img{width:50px;height:50px;margin-top:0}.main-container .profile-grid .u-info h2{font-size:12px}.main-container .profile-grid .u-info label{border-width:1px;font-size:10px;width:100%;margin-top:0}}
</style>
