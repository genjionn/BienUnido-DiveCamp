  ...
  <head>
    <style>
        *, *:before, *:after{margin:0;padding:0;box-sizing:border-box;font-family:'Poppins', sans-serif;}
        ...
        .container .cover h1{position:relative;top:180px;color:white;}
        ...
        form .form-content .button input:hover{color:white;background:#D4A91C;}
        form .form-content label{color:#916F00;cursor:pointer;}
        ...
        form .text a{color:#916F00;}
        .container #flip{display:none;}
        @media (max-width:730px){.container .cover{display:none;}
        .form-content .login-form, .form-content .picture-form{width:100%;}
